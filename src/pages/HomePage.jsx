            ...
            <div className="flex flex-col space-y-8 lg:order-1 order-2">
              ...
              >
                <h2 className="text-3xl md:text-5xl font-serif font-bold tracking-tight text-gray-900 leading-tight">
                  Shaping <span className="text-[#c89434] italic">Future Success</span>
                </h2>
              ...
              <div className="relative rounded-sm overflow-hidden shadow-2xl shadow-gray-200 border border-gray-100 group">
                ...
                {hero.floatingCards.map((card, index) => (
                  <motion.div
                    ...
                    className={`absolute ${index === 0 ? 'top-8 left-8' : 'bottom-8 right-8'} bg-white/95 backdrop-blur-md border border-gray-200 p-5 rounded-sm shadow-xl max-w-[200px]`}
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 ${index === 0 ? 'bg-[#c89434]/10 text-[#c89434]' : 'bg-gray-100 text-gray-800'} rounded-full flex items-center justify-center`}>
                        {index === 0 ? (
